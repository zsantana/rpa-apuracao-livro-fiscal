...
/**
 * Tests of the FuncionarioResourceTest REST endpoints
 */
@QuarkusTest
public class FuncionarioResourceTest {
    ...
    public void testHelloRolesAllowedAdmin() {
        ...
        response.then()
                .statusCode(200)
                .body(containsString(
                        "hello + jdoe@quarkus.io, isHttps: false, authScheme: Bearer, hasJWT: true, birthdate: 2050-07-13"));
    }
    ...
    static String generateValidAdminToken() {
        String token =  Jwt.upn("jdoe@quarkus.io")
                .issuer("https://example.com/issuer")
                .groups("Admin")
                .claim(Claims.birthdate.name(), "2050-07-13")
                .sign();
